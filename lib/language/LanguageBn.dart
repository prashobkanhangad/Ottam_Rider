...
class LanguageBn extends BaseLanguage {
  ...
  @override
  String get signInYourAccount => 'আপনার অ্যাকাউন্টে সাইন ইন করুন';
  ...
  @override
  String get createYourAccountToContinue => 'চালিয়ে যেতে আপনার অ্যাকাউন্ট তৈরি করুন';
  ...
  @override
  String get enterTheEmailAssociatedWithYourAccount => 'আপনার অ্যাকাউন্টের সাথে সম্পর্কিত ইমেলটি প্রবেশ করান';
  ...
  @override
  String get weHaveSentDigitCode => 'আমরা একটি 4 ডিজিট কোড প্রেরণ করেছি';

  @override
  String get contactLength => 'যোগাযোগের সংখ্যা দৈর্ঘ্য 10 থেকে 14 ডিজিটের হতে হবে।';
  ...
  @override
  String get notChangeUsername => 'আপনি ব্যবহারকারীর নাম পরিবর্তন করতে পারবেন না';
  ...
  @override
  String get areYouSureYouWantDeleteThisNumber => 'আপনি কি নিশ্চিত যে আপনি এই নম্বরটি মুছতে চান?';

  @override
  String get addContact => 'পরিচিতি যোগ করুন';

  @override
  String get googleMap => 'গুগল মানচিত্র';

  @override
  String get save => 'সংরক্ষণ';

  @override
  String get myRides => 'আমার রাইডস';

  @override
  String get myWallet => 'আমার মানিব্যাগ';
  ...
  @override
  String get chooseYouPaymentLate => 'এখনই বা দেরিতে আপনার অর্থ প্রদান চয়ন করুন';
  ...
  @override
  String get createdAt => 'এ নির্মিত';
  ...
  @override
  String get timePrice => 'সময় মূল্য';
  ...
  @override
  String get waitingForDriverConformation => 'ড্রাইভার নিশ্চিতকরণের জন্য অপেক্ষা করছি';
  ...
  @override
  String get myTrips => 'আমার ট্রিপস';
  ...
  @override
  String get areYouSureYouWantToLogoutThisApp => 'আপনি কি নিশ্চিত যে আপনি এই অ্যাপটি লগআউট করতে চান?';
  ...
  @override
  String get weAreLookingForNearDriversAcceptsYourRide => 'আমরা আপনার যাত্রায় \ nccepts জন্য কাছাকাছি ড্রাইভার খুঁজছি';

  @override
  String get areYouSureYouWantToCancelThisRide => 'আপনি কি নিশ্চিত যে আপনি এই যাত্রাটি বাতিল করতে চান?';

  @override
  String get serviceDetail => 'পরিষেবা বিশদ';
  ...
  @override
  String get enterTheCodeSendTo => 'কোড সেন্ডটো প্রবেশ করান';

  @override
  String get didNotReceiveTheCode => 'কোডটি গ্রহণ করেনি';

  @override
  String get resend => 'পুনরায় পাঠানো';
  ...
  @override
  String get signInUsingYourMobileNumber => 'আপনার \ nmobile নম্বর ব্যবহার করে সাইন ইন করুন';
  ...
  @override
  String get pleaseEnableLocationPermission => 'অবস্থানের অনুমতি সক্ষম করুন';
  ...
  @override
  String get areYouSureYouWantPleaseReadAffect => 'আপনি আপনার অ্যাকাউন্ট মুছে ফেলতে চান আপনি কি নিশ্চিত? অ্যাকাউন্ট মুছে ফেলা কীভাবে প্রভাবিত করবে দয়া করে পড়ুন।';
  ...
  @override
  String get areYouSureYouWantDeleteAccount => 'আপনি কি অ্যাকাউন্ট মুছতে চান তা নিশ্চিত?';
  ...
  @override
  String get mostReliableMightyRiderApp => 'সবচেয়ে নির্ভরযোগ্য শক্তিশালী রাইডার অ্যাপ';

  @override
  String get toEnjoyYourRideExperiencePleaseAllowPermissions => 'আপনার রাইডের অভিজ্ঞতা উপভোগ করতে \ n দয়া করে আমাদের নিম্নলিখিত অনুমতিগুলি অনুমতি দিন';
  ...
  @override
  String get demoMsg => 'পরীক্ষকের ভূমিকা এই ক্রিয়াটি সম্পাদন করার অনুমতি দেয় না';
  ...
  @override
  String get youCannotChangePhoneNumber => 'আপনি ফোন নম্বর পরিবর্তন করতে পারবেন না';
  ...
  @override
  String get pleaseAcceptTermsOfServicePrivacyPolicy => 'পরিষেবা এবং গোপনীয়তা নীতি শর্তান';
  ...
  @override
  String get bookingRideForOthers => 'অন্যের জন্য যাত্রা বুকিং';

  @override
  String get selectGender => 'লিংগ নির্বাচন';
  ...
  @override
  String get lblCouponCode => 'কুপন কোড:';

  @override
  String get lblRide => 'যাত্রা';

  @override
  String get lblRideInformation => 'রাইড তথ্য';
  ...
  @override
  String get lblWhoRiding => 'কে চড়বে?';
  ...
  @override
  String get lblWhoRidingMsg => 'রাইডারটি নিশ্চিত করুন এবং ভ্রমণের তথ্য নিশ্চিত করুন';

  @override
  String get lblNext => 'পরবর্তী';

  @override
  String get lblLessWalletAmount => 'দ্রষ্টব্য: আপনার মানিব্যাগে আপনার অপর্যাপ্ত ভারসাম্য রয়েছে। অন্যথায় পরিমাণ যুক্ত করুন, আপনাকে নগদ অর্থের মাধ্যমে দিতে হবে।';

  @override
  String get lblPayWhenEnds => 'ট্রিপ শেষ হলে প্রদান';

  @override
  String get searchYourRide => 'আপনার যাত্রা অনুসন্ধান করুন';

  @override
  String get requestGetPickedCommunityDriver => 'কাছাকাছি সম্প্রদায় ড্রাইভার দ্বারা যাত্রার জন্য যাত্রার জন্য অনুরোধ করুন';

  @override
  String get selectYourRide => 'আপনার যাত্রা নির্বাচন করুন';

  @override
  String get trackYourRide => 'আপনার যাত্রা ট্র্যাক করুন';

  @override
  String get knowYourServiceLocationMap => 'আপনার পরিষেবাটি জানুন এবং মানচিত্রে রিয়েল টাইমে \ ncurrent অবস্থান দেখতে সক্ষম হবেন';

  @override
  String get vatAmount => 'ভ্যাট পরিমাণ';
  ...
  @override
  String get pickUpTimeTakingTooLong => 'খুব বেশি সময় নিতে সময় নিন';
  ...
  @override
  String get perDistance => 'প্রতি দূরত্বে';
  ...
  @override
  String get pleaseEnterOtp => 'আপনার মোবাইল নম্বর যাচাই করতে দয়া করে নীচে ওটিপি প্রবেশ করুন।';
