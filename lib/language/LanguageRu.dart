...
class LanguageRu extends BaseLanguage {
  ...
  @override
  String get signInYourAccount => 'Войдите в свой аккаунт';
  ...
  @override
  String get createYourAccountToContinue => 'Создайте свою учетную запись, чтобы продолжить';
  ...
  @override
  String get enterTheEmailAssociatedWithYourAccount => 'Введите электронное письмо, связанное с вашей учетной записью';
  ...
  @override
  String get weHaveSentDigitCode => 'Мы отправили 4 -значный код';

  @override
  String get contactLength => 'Длина контакта должна составлять от 10 до 14 цифр.';

  @override
  String get about => 'О';

  @override
  String get useInCaseOfEmergency => 'Использовать в случае чрезвычайной ситуации';
  ...
  @override
  String get saveComplain => 'Сохранить жаловаться';
  ...
  @override
  String get notChangeEmail => 'Вы не можете изменить идентификатор электронной почты';
  ...
  @override
  String get areYouSureYouWantDeleteThisNumber => 'Вы уверены, что хотите удалить этот номер?';
  ...
  @override
  String get myWallet => 'Мой бумажник';
  ...
  @override
  String get timePrice => 'Временная цена';
  ...
  @override
  String get waitingForDriverConformation => 'В ожидании подтверждения водителя';
  ...
  @override
  String get areYouSureYouWantToLogoutThisApp => 'Вы уверены, что хотите выходить из этого приложения?';
  ...
  @override
  String get weAreLookingForNearDriversAcceptsYourRide => 'Мы ищем близлежащих водителей, чтобы \ naccepts';

  @override
  String get areYouSureYouWantToCancelThisRide => 'Вы уверены, что хотите отменить эту поездку?';

  @override
  String get serviceDetail => 'Служба деталь';
  ...
  @override
  String get fare => 'Плата за проезд';
  ...
  @override
  String get enterTheCodeSendTo => 'Введите код Sendto';

  @override
  String get didNotReceiveTheCode => 'Не получил код';
  ...
  @override
  String get signInUsingYourMobileNumber => 'Войдите, используя свой номер \ nmobile';
  ...
  @override
  String get pleaseEnableLocationPermission => 'Пожалуйста, включите разрешение на местоположение';
  ...
  @override
  String get areYouSureYouWantPleaseReadAffect => 'Вы уверены, что хотите удалить свою учетную запись? Пожалуйста, прочитайте, как повлияет удаление учетной записи.';
  ...
  @override
  String get areYouSureYouWantDeleteAccount => 'Вы уверены, что хотите удалить учетную запись?';
  ...
  @override
  String get mostReliableMightyRiderApp => 'Самое надежное приложение Mighty Rider';

  @override
  String get toEnjoyYourRideExperiencePleaseAllowPermissions => 'Чтобы насладиться опытом поездки \ nplease, позвольте нам следующие разрешения';
  ...
  @override
  String get youCannotChangePhoneNumber => 'Вы не можете изменить номер телефона';
  ...
  @override
  String get pleaseAcceptTermsOfServicePrivacyPolicy => 'Пожалуйста, принимайте условия обслуживания и политики конфиденциальности';
  ...
  @override
  String get bookingRideForOthers => 'Бронирование поездки для других';
  ...
  @override
  String get lblCouponCode => 'Код купона:';
  ...
  @override
  String get lblWhoRiding => 'Кто будет ездить?';
  ...
  @override
  String get lblWhoRidingMsg => 'Подтвердите гонщика и убедитесь, что информация о поездке';

  @override
  String get lblNext => 'Следующий';

  @override
  String get lblLessWalletAmount => 'Примечание: у вас есть недостаточный баланс в вашем кошельке. Добавьте сумму иначе, вы должны заплатить через наличные.';

  @override
  String get lblPayWhenEnds => 'Платить, когда поездка заканчивается';

  @override
  String get searchYourRide => 'Ищите свою поездку';

  @override
  String get requestGetPickedCommunityDriver => 'Запросить поездку, получившая \ na Na Ne';

  @override
  String get selectYourRide => 'Выберите свою поездку';

  @override
  String get trackYourRide => 'Отслеживайте свою поездку';

  @override
  String get knowYourServiceLocationMap => 'Знать свой сервис и иметь возможность просматривать местоположение \ ncurrent в режиме реального времени на карте';

  @override
  String get vatAmount => 'Сумма НДС';
  ...
  @override
  String get driverGoingWrongDirection => 'Драйвер, идущий неправильный направление';

  @override
  String get pickUpTimeTakingTooLong => 'Получите время, чтобы занять слишком много времени';
  ...
  @override
  String get checkConsoleForError => 'Проверьте консоль на наличие ошибки';
  ...
  @override
  String get otpCodeHasBeenSentTo => 'OTP -код был отправлен в';

  @override
  String get pleaseEnterOtp => 'Пожалуйста, введите OTP ниже, чтобы проверить свой номер мобильного телефона.';
